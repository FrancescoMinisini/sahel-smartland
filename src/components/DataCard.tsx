...
const DataCard = ({
  ...
  return (
    <div 
      className={cn(
        "bg-white dark:bg-card rounded-xl p-5 shadow-sm border border-border/40 hover:shadow-md transition-all duration-300",
    ...
    >
      <div className="flex justify-between items-start mb-4">
        ...
        {icon && <div className="text-sahel-earth/80 dark:text-sahel-sandLight/80">{icon}</div>}
      </div>
      ...
      {onClick && (
        <div className="mt-3 text-xs flex items-center text-sahel-blue dark:text-sahel-blueLight font-medium">
